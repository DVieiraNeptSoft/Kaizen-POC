...
var options = {
    ...
    data: {
        ...
        stage: "L2",
        L2approver: AppCache.userInfo.username,
        L2approver_dateApproved: approvedTodayDate,
        ...
        targetedWorkingCapitalImprovement:
            modelSimpleFormL1.getData().targetedWorkingCapitalImprovement,
...
apiRestAPIpostProjectsL2Approval(options);
